...
const ProbateAdministration = () => {
  return (
    <>
      <div className=''>
        <section className='w-full h-[40vh] mdk:h-[70vh] bg-fixed bg-no-repeat bg-cover relative'
        ...
        >
          <div className='absolute top-0 w-full h-full bg-[#1B3452] bg-opacity-40 flex flex-col items-center justify-center font-lato text-white'>
            <h1 className='text-3xl md:text-6xl font-bold subpixel-antialiased'>Probate & Administration</h1>
          </div>
