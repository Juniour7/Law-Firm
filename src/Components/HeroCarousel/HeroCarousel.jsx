...
const HeroCarousel = () => {
    const CustomPrevArrow = ({ onClick }) => {
        return (
          <div
            className="absolute left-[5%] w-[60px] h-[60px] top-1/2 transform -translate-y-1/2 flex flex-col justify-center items-center bg-black bg-opacity-50 text-white p-2 cursor-pointer hover:bg-opacity-60 z-10"
            onClick={onClick}
          >
    ...
    const CustomNextArrow = ({ onClick }) => {
        return (
          <div
            className="absolute right-[5%] w-[60px] h-[60px] top-1/2 transform -translate-y-1/2 flex flex-col justify-center items-center bg-black bg-opacity-50 text-white p-2 cursor-pointer hover:bg-opacity-60 z-10"
            onClick={onClick}
          >
            <span className='text-4xl'>
                <FiChevronRight />
                ...
                <Slider {...settings}>
                    <div className='w-full lg:h-screen relative'>
                        ...
                        <div className='absolute inset-0 flex flex-col justify-center items-center h-full w-full bg-black bg-opacity-50'>
                            <div className='w-[60%] mx-auto text-center absolute'>
                                <h1 className=' text-white text-8xl font-semibold'>Lawyer assistance and advice</h1>
                    ...
                    <div className='w-full h-screen relative'>
                        ...
                        <div className='absolute inset-0 flex flex-col justify-center items-center h-full w-full bg-black bg-opacity-50'>
                            <div className='w-[60%] mx-auto text-center absolute'>
                                <h1 className=' text-white text-6xl font-semibold'>Comprehensive Legal Support for Every Step of Your Journey</h1>
                    ...
                    <div className='w-full h-screen relative'>
                        ...
                        <div className='absolute inset-0 flex flex-col justify-center items-center h-full w-full bg-black bg-opacity-50'>
                            <div className='w-[70%] mx-auto text-center absolute'>
                                <h1 className=' text-white text-7xl font-semibold'>Trusted Advocates Committed to Your Success.</h1>
